  ...
  render() {
    return (
      <div className="row">
        ...
        {/* below is an if statement, saying if the data exists then show information, must return one element from statement, which is why we wrapped all 5 elements ina single div*/}
          {
          ...
          {/* Error message will appear if they put in a city that does not exist*/}
